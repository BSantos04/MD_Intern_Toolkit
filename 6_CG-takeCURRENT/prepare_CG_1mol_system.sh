...
gmx_20251cuda solvate -cp ${solute} -cs ${solvent_box} -o initial.gro -box 4.5 4.5 4.5 # NEW!
...
gmx_20251cuda grompp -p system.top -c initial.gro -f martini_em_mod.mdp  -o 1-min.tpr -po 1-min.mdp  -maxwarn 1
gmx_20251cuda mdrun -v -deffnm 1-min

gmx_20251cuda grompp -p system.top -c 1-min.gro   -f martini_eq_mod.mdp  -o 2-eq.tpr  -po 2-eq.mdp 
gmx_20251cuda mdrun -v -deffnm 2-eq

gmx_20251cuda grompp -p system.top -c 2-eq.gro    -f martini_run.mdp -o 3-run.tpr -po 3-run.mdp 
gmx_20251cuda mdrun -v -deffnm 3-run
